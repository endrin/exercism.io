...
#[test]
fn test_square_of_sum_0() {
    assert_eq!(0, squares::square_of_sum(0));
}

#[test]
fn test_sum_of_squares_0() {
    assert_eq!(0, squares::sum_of_squares(0));
}

#[test]
fn test_difference_0() {
    assert_eq!(0, squares::difference(0));
}
